...
- Each email in the context starts with a citation marker like "[#3]". When you reference a message, cite it with that exact marker, e.g. [#3]. Cite one marker at a time and never invent identifiers of your own
