...
export function SignatureEditor() {
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      ...
      setSaveError(t("settings.signatureEditor.saveFailed"));
    }
  ...
  const handleImport = useCallback(async (sourceId: string) => {
    ...
    try {
      ...
      setImportError(t("settings.signatureEditor.importFailed"));
    }
        ...
        >
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              ...
              title={t("settings.signatureEditor.removeFromAccount")}
            >
              <Trash2 size={13} />
            </button>
          </div>
          ...
          {(signatures.length > 0 || showForm) && (
            <div className="flex items-center gap-2 my-1">
              ...
              <span className="text-[0.65rem] text-text-tertiary whitespace-nowrap">
                {t("settings.signatureEditor.availableFromOtherAccounts")}
              </span>
              <div className="flex-1 h-px bg-border-primary" />
            </div>
          )}
          {availableSignatures.map((sig) => (
            ...
            >
              ...
              <button
                ...
                title={t("settings.signatureEditor.activateForAccount")}
              >
                <Download size={13} />
              </button>
            </div>
      ...
      {showForm ? (
        <div className="border border-border-primary rounded-md p-3 space-y-2">
            ...
            <div className="flex items-center justify-between">
              {isHtmlMode ? (
                <span className="px-2 py-1 text-xs text-text-secondary">
                  {t("settings.signatureEditor.htmlSource")}
                </span>
              ) : (
              ...
              <button
                ...
                title={isHtmlMode ? t("settings.signatureEditor.switchToVisual") : t("settings.signatureEditor.editHtmlSource")}
              >
                <Code size={14} />
              </button>
            </div>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              {editingId ? t("settings.signatureEditor.update") : t("settings.signatureEditor.save")}
            </button>
            <button
              type="button"
              onClick={resetForm}
